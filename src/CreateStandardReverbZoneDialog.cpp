...
CreateStandardReverbZoneDialog::CreateStandardReverbZoneDialog(const wxString& title,EffectsManager* effects_manager) : wxDialog(NULL, -1, title, wxDefaultPosition, wxSize(250, 230))
{
	okClicked = false;
