       ...
       : wxDialog(NULL, -1, title, wxDefaultPosition, wxSize(500, 250), wxRESIZE_BORDER)
{
	...
	LCCOutputDialog::initPrivateVariables();
	...
	listboxReverbZones->Bind(wxEVT_LISTBOX,&LCCOutputDialog::ReverbZoneSelectedInListBox,this);
	...
	listboxSoundProducers->Bind(wxEVT_LISTBOX,&LCCOutputDialog::SoundProducerTrackSelectedInListBox,this);
	...
	okButton->Bind(wxEVT_BUTTON,&LCCOutputDialog::OnOk,this);
	
	applyButton = new wxButton(this, wxID_ANY, wxT("Apply"), 
							wxDefaultPosition, wxSize(70, 30));
	
	applyButton->Bind(wxEVT_BUTTON,&LCCOutputDialog::OnApply,this);
	
	cancelButton = new wxButton(this, wxID_ANY, wxT("Cancel"), 
								wxDefaultPosition, wxSize(70, 30));
	
	cancelButton->Bind(wxEVT_BUTTON,&LCCOutputDialog::OnCancel,this);
	
	previewButton = new wxButton(this, wxID_ANY, wxT("Preview"), 
								wxDefaultPosition, wxSize(70, 30));
	
	previewButton->Bind(wxEVT_BUTTON,&LCCOutputDialog::OnPreview,this);
...
void LCCOutputDialog::initPrivateVariables()
{
	m_selection_index = -1;
...
void LCCOutputDialog::ChangeReverbZoneAttributes()
{
...
void LCCOutputDialog::OnPreview(wxCommandEvent& event)
{
...
void LCCOutputDialog::OnApply(wxCommandEvent& event)
{
	LCCOutputDialog::ChangeReverbZoneAttributes();	
}

void LCCOutputDialog::OnOk(wxCommandEvent& event )
{
	LCCOutputDialog::ChangeReverbZoneAttributes();
...
void LCCOutputDialog::OnCancel(wxCommandEvent& event)
{
	LCCOutputDialog::Exit();
}
...
void LCCOutputDialog::ReverbZoneSelectedInListBox(wxCommandEvent& event )
{
...
void LCCOutputDialog::SoundProducerTrackSelectedInListBox(wxCommandEvent& event )
{
