...
class EditorManipulator : public osgGA::OrbitManipulator
{
    ...
    public:
        ...
        EditorManipulator( const EditorManipulator& om,
    ...
    protected:
        ...
        virtual void performMovementKeyW(const double eventTimeDelta, const double dx, const double dy );
...
inline double EditorManipulator::getTrackballSize() const  { return _trackballSize; }
/** Get the mouse wheel zoom factor.*/
inline double EditorManipulator::getWheelZoomFactor() const  { return _wheelZoomFactor; }
